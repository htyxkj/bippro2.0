<template>
    <div class="linechart" id="linecharthb">
...
export default{
    ...
    methods:{
        async init(){
            ...
            // this.linecharts = Highcharts.chart("linecharthb",this.options);
            this.linecharts = this.Highcharts.chart("linecharthb",this.options);
            this.updateOpt();
        }, 
        updateOpt(){
