        ...
        fileInput.addEventListener('change', function () {
            ...
            reader.addEventListener("load", function () {
                if(document.getElementById(id)){
                    document.getElementById(id).getElementsByTagName('img')[0].src = reader.result
                }
            }, false);
...
.classA{min-height:2.1rem;min-width:6rem;max-width:6rem;max-height: 5rem;}
.classAA{overflow:auto;max-height: 2.5rem}
.actionC{position: absolute;bottom:.1rem;right: .1rem}
.contentC{margin-bottom: 1rem;}
</style>
